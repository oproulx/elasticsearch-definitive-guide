...
Elasticsearch cluster.  Before installing Sense, please follow the https://www.elastic.co/guide/en/kibana/current/setup.html[Kibana installation instructions].
